...
type IStorage interface {
	...
	CloneDiskFromStorage(ctx context.Context, srcStorage IStorage, srcDisk IDisk, targetDiskId string, fullCopy bool) (*host.ServerCloneDiskFromStorageResponse, error)
