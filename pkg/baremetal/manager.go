...
func (b *SBaremetalInstance) SyncServerStatus(powerStatus types.PowerStatus) {
	...
	params := &apis.PerformStatusInput{}
...
func (b *SBaremetalInstance) postAttachWire(ctx context.Context, mac net.HardwareAddr, nicType compute.TNicType, netType string, ipAddr string) error {
	if ipAddr == "" {
		switch nicType {
...
func (s *SBaremetalServer) DoDeploy(tool *disktool.SSHPartitionTool, term *ssh.Client, data jsonutils.JSONObject, isInit bool) (jsonutils.JSONObject, error) {
	...
	deployInfo := deployapi.NewDeployInfo(publicKey, deployArray, password, isRandomPassword, true, o.Options.LinuxDefaultRootUser, o.Options.WindowsDefaultAdminUser, false, "", false, "", userData, isInit)
