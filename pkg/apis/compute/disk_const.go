...
var DISK_CACHE_MODES = []string{
	DISK_CACHE_MODE_WRITETHROGH,
	DISK_CACHE_MODE_NONE,
	DISK_CACHE_MODE_WRITEBACK,
	DISK_CACHE_MODE_DIRECTSYNC,
}
...
var DISK_AIO_MODES = []string{
	DISK_AIO_MODE_NATIVE,
	DISK_AIO_MODE_THREADS,
	DISK_AIO_MODE_IO_URING,
}

const (
	DISK_PERFORMANCE_HIGH   = "high"
	DISK_PERFORMANCE_NORMAL = "normal"
)
